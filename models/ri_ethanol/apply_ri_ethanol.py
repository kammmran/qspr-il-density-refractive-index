...
default_model_dir = "RI_ethanol_ensemble_model"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Apply the consensus model to predict refractive index of IL in ethanol.")
    parser.add_argument(
    ...
    parser.add_argument(
        "--model_dir", help="Directory containing the ensemble of models and metadata (default: RI_ethanol_ensemble_model).")
    parser.add_argument(

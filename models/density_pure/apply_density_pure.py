...
default_model_dir = "density_pure_ensemble_model"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Apply the consensus model to predict density of pure IL (not a mixture).")
    parser.add_argument(
    ...
    parser.add_argument(
        "--model_dir", help="Directory containing the ensemble of models and metadata (default: density_pure_ensemble_model).")
    parser.add_argument(
